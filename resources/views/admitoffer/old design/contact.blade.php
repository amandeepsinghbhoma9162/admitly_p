                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate" data-sal="slide-up" data-sal-delay="150" data-sal-duration="800">
                    <div class="rbt-address">
                        ...
                        <div class="inner">
                            ...
                            <p><a href="tel:(+91) 7087078585">(+91) 7087078585</a></p>
                            <p><a href="tel:(+682) 55202">(+682) 55202</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate" data-sal="slide-up" data-sal-delay="200" data-sal-duration="800">
                    <div class="rbt-address">
                        ...
                        <div class="inner">
                            ...
                            <p><a href="mailto:contact@admitoffer.com">contact@admitoffer.com</a></p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate" data-sal="slide-up" data-sal-delay="250" data-sal-duration="800">
                    <div class="rbt-address">
                        ...
                        <div class="inner">
                            ...
                            <p>Chandigarh Office - 2nd Floor, SCO 1128-29 (Above Patanjali Store), Sector - 22-B<br> Chandigarh-160022</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="rbt-contact-address">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="thumbnail">
                        <img class="w-100 radius-6" src="{{asset('admitly/images/contact.jpg')}}" alt="Contact Images">
                    </div>
                </div>
