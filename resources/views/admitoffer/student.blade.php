                ...
                <div class="span11 abt">
                    <div class="row align-items-center">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="zoom-banner text-center" id="zoom" style="background: #da261e;">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="heading">
                                                ...
                                                <p style="background: #da261e; margin-right: 30px!important;">Venue: Nepal Admission Overseas, Kings way tower, Near Ghantaghar, Kathmandu.<br>
                                                    <i class="fa fa-calendar"></i> June 27th, 2024, from 10:00AM Onwards
                                                </p>
                                            </div>
                                        </div>
                                    </div>
