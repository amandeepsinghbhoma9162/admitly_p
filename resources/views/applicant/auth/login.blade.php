                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-6">
                        <div class="contact-bg max-width-auto">
                            ...
                            @endif
                            <form action="{{ route('applicant.login') }}" method="post" id="contact-form">
                              @csrf
                        <div class="rounded-0">
                            ...
                            <div class="col-md-6 form-group v-center text-right"><a href="{{ route('agent.password.request') }}" class="psforgt">Forgot Password?</a> </div>
                            <div class="float-right" style="text-align: right; margin-top: -45px;" >
                            <a href="{{ route('applicant.register') }}" class="btn-main fb-btn"><i class="fab fa-facebook-f"></i>Sign Up</a></div>
                            </div>
