                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <div>
                                        {{ $appliedStudentFile->agent['company_name'] }}
                                    </div>
                                    <div>
                                        <!-- <p>{{ $appliedStudentFile->agent['email'] }}</p> -->
                                        {{ $appliedStudentFile->agent['mobileno'] }}
                                    </div>
                                    </div>
                                </td>
                                <td class="text-center" style="text-transform: lowercase;">{{ $appliedStudentFile->email }}</td>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{route('student.program.add',base64_encode($appliedStudentFile->id))}}" class=" btn btn-sm btn-info edit_1"data-toggle="tooltip" title="Add Programs"><i class="pe-7s-plus"></i></a>
                                    <a href="{{route('admin.student.chat',base64_encode($appliedStudentFile['id']))}}" class="btn btn-success"data-toggle="tooltip" title="Student Chat"><i class="fa fa-comment"> </i><span style="position: absolute; background: #ff6000; padding: 10px; border-radius: 50%; margin-top: 10px; font-weight: 800; top: -23px;">
                                        @if($appliedStudentFile->studentNotifications)
                                        {{$appliedStudentFile->studentNotifications->count()}}
                                        @endif
                                        </span>
