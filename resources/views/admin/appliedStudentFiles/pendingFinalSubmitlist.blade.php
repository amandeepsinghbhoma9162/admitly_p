                ...
                <table data-order='[[ 0, "desc" ]]' class="align-middle text-truncate mb-0 table table-borderless  table-hover tableID" >
                    ...
                    @foreach ($appliedStudentFiles as $appliedStudentFile)
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="badge badge-pill badge-danger">{{ $appliedStudentFile->applied_at }}</div>
                            </td>
                            ...
                            <td class="text-center">
                                <a href="{{route('studentfiles.show',base64_encode($appliedStudentFile->id))}}" class=" btn btn-sm btn-info "class=" btn btn-sm btn-info view_1" data-toggle="tooltip" title="View"><i class="pe-7s-look"></i></a>
                                <a href="{{route('admin.student.chat',base64_encode($appliedStudentFile['id']))}}" class="btn btn-success" class=" btn btn-sm btn-info view_1" data-toggle="tooltip" title="Student Chat"><i class="fa fa-comment"></i></a>
