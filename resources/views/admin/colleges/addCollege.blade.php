                    ...
                    @csrf
                        ...
                        <div class="form-group row">  
                         ...
                         <div class="form-group row">  
                            ...
                            <div class="col-sm-10">
                                <input type="checkbox" name="isFeeRequiredForNepal" value="yes"> Yes
                            </div>
                        </div>
                        <div class="form-group row">  
                            <label for="input-id" class="col-sm-2">Is Card details required ?</label>
                            <div class="col-sm-10">
                                <input type="checkbox" name="isCardRequired" value="yes"> Yes
                            </div>
                        </div>
                        <div class="form-group row">  
                            <label for="input-id" class="col-sm-2">Is Student signed documents required ?</label>
                            <div class="col-sm-10">
                                <input type="checkbox" name="isDocumentRequired" value="yes"> Yes
                                <input type="file" name="collegeSignedDocument" accept="application/pdf"> &nbsp; (Upload document )
                            </div>
                        </div>
