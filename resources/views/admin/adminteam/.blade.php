            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="btn btn-danger "  style="margin: 2px!important;"><a class="text-white uprTabs active"  data-toggle="tab" href="#menu12">Total Reports</a></li><br>
                        <li class="btn btn-danger " style="margin: 2px!important;"><a class="text-white uprTabs"  data-toggle="tab" href="#home">AM's</a></li><br>
                        <li class="btn btn-danger " style="margin: 2px!important;"><a class="text-white uprTabs" data-toggle="tab"  href="#menu1">Pre Processing Team</a></li><br>
                        <li class="btn btn-danger " style="margin: 2px!important;"><a class="text-white uprTabs" data-toggle="tab"  href="#menu4">Process Team</a></li><br>
                        <li class="btn btn-danger " style="margin: 2px!important;"><a class="text-white uprTabs"  data-toggle="tab" href="#menu2">Shortlisting Team</a></li><br>
                        <li class="btn btn-danger " style="margin: 2px!important;"><a class="text-white uprTabs" data-toggle="tab" href="#menu3">Attendance</a></li><br>
                    </ul>
                            ...
                            <table data-order='[[ 0, "desc" ]]' class="align-middle text-truncate mb-0 table table-borderless cell-border table-hover tableID" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center {{($accountManager['calls']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$accountManager['calls']}}</div>
                                        </td>
                                        <td class="text-center {{($accountManager['emails']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$accountManager['emails']}}</div>
                                        </td>
                                        <td class="text-center {{($accountManager['canada_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$accountManager['canada_applications']}}</div>
                                        </td>
                                        <td class="text-center {{($accountManager['uk_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$accountManager['uk_applications']}}</div>
                                        </td>
                                        <td class="text-center {{($accountManager['aus_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$accountManager['aus_applications']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($accountManager['canada_payments']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$accountManager['canada_payments']}}</div>
                                        </td>
                                        <td class="text-center {{($accountManager['uk_payments']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$accountManager['uk_payments']}}</div>
                                        </td>
                                        <td class="text-center {{($accountManager['aus_payments']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$accountManager['aus_payments']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($accountManager['canada_offers']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$accountManager['canada_offers']}}</div>
                                        </td>
                                        <td class="text-center {{($accountManager['uk_offers']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$accountManager['uk_offers']}}</div>
                                        </td>
                                        <td class="text-center {{($accountManager['aus_offers']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$accountManager['aus_offers']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($accountManager['remarks']) ?  'bg-success' : 'bg-danger'}}">
                            ...
                            <table data-order='[[ 0, "desc" ]]' class="align-middle text-truncate mb-0 table table-borderless cell-border table-hover tableID" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center {{($preprocess['received_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$preprocess['received_applications']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($preprocess['canada_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$preprocess['canada_applications']}}</div>
                                        </td>
                                        <td class="text-center {{($preprocess['uk_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$preprocess['uk_applications']}}</div>
                                        </td>
                                        <td class="text-center {{($preprocess['aus_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$preprocess['aus_applications']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($preprocess['canada_payments']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$preprocess['canada_payments']}}</div>
                                        </td>
                                        <td class="text-center {{($preprocess['uk_payments']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$preprocess['uk_payments']}}</div>
                                        </td>
                                        <td class="text-center {{($preprocess['aus_payments']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$preprocess['aus_payments']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($preprocess['canada_offers']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$preprocess['canada_offers']}}</div>
                                        </td>
                                        <td class="text-center {{($preprocess['uk_offers']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$preprocess['uk_offers']}}</div>
                                        </td>
                                        <td class="text-center {{($preprocess['aus_offers']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$preprocess['aus_offers']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($preprocess['remarks']) ?  'bg-success' : 'bg-danger'}}">
                            ...
                            <table data-order='[[ 0, "desc" ]]' class="align-middle text-truncate mb-0 table table-borderless cell-border table-hover tableID" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center {{($process['received_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$process['received_applications']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($process['canada_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$process['canada_applications']}}</div>
                                        </td>
                                        <td class="text-center {{($process['uk_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$process['uk_applications']}}</div>
                                        </td>
                                        <td class="text-center {{($process['aus_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$process['aus_applications']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($process['canada_payments']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$process['canada_payments']}}</div>
                                        </td>
                                        <td class="text-center {{($process['uk_payments']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$process['uk_payments']}}</div>
                                        </td>
                                        <td class="text-center {{($process['aus_payments']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$process['aus_payments']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($process['canada_offers']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$process['canada_offers']}}</div>
                                        </td>
                                        <td class="text-center {{($process['uk_offers']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$process['uk_offers']}}</div>
                                        </td>
                                        <td class="text-center {{($process['aus_offers']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$process['aus_offers']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($process['remarks']) ?  'bg-success' : 'bg-danger'}}">
                            ...
                            <table data-order='[[ 0, "desc" ]]' class="align-middle text-truncate mb-0 table table-borderless cell-border table-hover tableID" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center {{($shortlisting['received_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$shortlisting['received_applications']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($shortlisting['canada_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$shortlisting['canada_applications']}}</div>
                                        </td>
                                        <td class="text-center {{($shortlisting['uk_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$shortlisting['uk_applications']}}</div>
                                        </td>
                                        <td class="text-center {{($shortlisting['aus_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$shortlisting['aus_applications']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($shortlisting['canada_payments']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$shortlisting['canada_payments']}}</div>
                                        </td>
                                        <td class="text-center {{($shortlisting['uk_payments']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$shortlisting['uk_payments']}}</div>
                                        </td>
                                        <td class="text-center {{($shortlisting['aus_payments']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$shortlisting['aus_payments']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($shortlisting['canada_offers']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$shortlisting['canada_offers']}}</div>
                                        </td>
                                        <td class="text-center {{($shortlisting['uk_offers']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$shortlisting['uk_offers']}}</div>
                                        </td>
                                        <td class="text-center {{($shortlisting['aus_offers']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$shortlisting['aus_offers']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($shortlisting['remarks']) ?  'bg-success' : 'bg-danger'}}">
                            ...
                            <table data-order='[[ 0, "desc" ]]' class="align-middle text-truncate mb-0 table table-borderless cell-border table-hover tableID" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center {{($totalDataReport['total_received_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$totalDataReport['total_received_applications']}}</div>
                                        </td>
                                        <td class="text-center {{($totalDataReport['total_pending_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$totalDataReport['total_pending_applications']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($totalDataReport['total_canada_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$totalDataReport['total_canada_applications']}}</div>
                                        </td>
                                        <td class="text-center {{($totalDataReport['total_uk_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$totalDataReport['total_uk_applications']}}</div>
                                        </td>
                                        <td class="text-center {{($totalDataReport['total_aus_applications']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$totalDataReport['total_aus_applications']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($totalDataReport['total_canada_payments']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$totalDataReport['total_canada_payments']}}</div>
                                        </td>
                                        <td class="text-center {{($totalDataReport['total_uk_payments']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$totalDataReport['total_uk_payments']}}</div>
                                        </td>
                                        <td class="text-center {{($totalDataReport['total_aus_payments']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$totalDataReport['total_aus_payments']}}</div>
                                        </td>
                                        
                                        <td class="text-center {{($totalDataReport['total_canada_offers']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$totalDataReport['total_canada_offers']}}</div>
                                        </td>
                                        <td class="text-center {{($totalDataReport['total_uk_offers']) ?  'bg-success' : 'bg-danger'}}">
                                            <div class="">{{$totalDataReport['total_uk_offers']}}</div>
                                        </td>
                                        <td class="text-center {{($totalDataReport['total_aus_offers']) ?  'bg-success' : 'bg-danger'}}">
