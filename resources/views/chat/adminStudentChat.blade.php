                    ...
                    <div class="form-group row capitalize">
                        <label for="input-id" class="col-sm-3 chatSidebar">
                             ...
                             <div class="chatSidebarName">
                                <div>
                                    <h5><i class="fa fa-user"></i> Student Details:</h5>
                                ...
                                <div>
                                    <h5><i class="fa fa-home"></i> Agent Details:</h5>
                                    
                                </div>
                                <div class="charSideDetail">
                                    <strong> Name: </strong> {{$student->agent['name']}}
                                </div>
                                <div class="charSideDetail">
                                    <strong>Company: </strong> {{$student->agent['company_name']}}
                                </div>
                                    ...
                                    @else
                                         ...
                                         <div class="you">
                                            ...
                                            <div class="mr-10">
                                                ...
                                                @if($ext == 'docx')
                                                <a href="{{asset($message['path'])}}" target="_blank">
                                                <img src="{{asset('images/site/doc.png')}}" width="40">
                                                </a>
                                                @elseif($ext == 'pdf')
                                                <a href="{{asset($message['path'])}}" target="_blank">
                                    ...
                                    <form method="POST" class="studentChatRequestForm">
                                        ...
                                        <div class=" row">
                                            <div class="col-md-12 ">
                                                ...
                                                <input type="hidden" name="hasDocument" class="hasDocument" value="">
