   ...
   <form method="POST" action="{{ route('agent.password.email') }}" aria-label="{{ __('Reset Password') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn-block btn2">
...
<div class="row loginRegisterFooter" >
  <div class="col-md-12">
    ...
    <!-- <div class="small_txt"><p>© Copyright 2019 . All Rights Reserved by Admit Offer Technologies Ltd.</p></div>  -->
    <div class="small_txt"><p>© Copyright 2023. All Rights Reserved by Supernova Edu Technologies Inc.</p></div> 
    </div>
  </div>
</div>
</div>
