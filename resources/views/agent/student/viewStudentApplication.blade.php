                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="{{route('student.show',base64_encode($student['id']))}}" class="btn btn-danger float-right btn-default-color">Back</a>
                            @endif
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-8" style="border: 1px solid #eee; margin-left: 30px;">
                                    ...
                                    <div class="col-md-6 " >
                                        <div class="row capitalize">
                                            ...
                                            <div class="col-md-5 " >
                                                <span class="capitalize">
                                                @if($studentCourseApplyFors->course)
                                                {{$student->country['currency_icon_name']}} {{$studentCourseApplyFors->course['tution_fee']}}
                                                @endif
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="row capitalize "  style="margin-top: 10px;">
                                    ...
                                    <div class="col-md-6 " >
                                        <div class="row capitalize">
                                            ...
                                            <div class="col-md-5 " >
                                                <span>{{$student->country['currency_icon_name']}} {{$studentCourseApplyFors->course['application_fee']}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row capitalize "  style="margin-top: 10px;">
                                            ...
                                            <div class="col-md-6 " >
                                                ...
                                                @if($studentCourseApplyFors->course)
                                                    @if($studentCourseApplyFors->course->intakes)
                                                        @if($studentCourseApplyFors['change_intake'])
                                                            {{$studentCourseApplyFors->change_intakes['name']}}
                                                        @else
                                    ...
                                    <div class="col-md-6 " >
                                        <div class="row capitalize">
                                            ...
                                            <div class="col-md-5 " >
                                                <span>{{$student->country['currency_icon_name']}} {{$studentCourseApplyFors->course['agent_commission']}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row capitalize interviewSch mb-3" >
                                    <div class="col-md-6 " >
                                        ...
                                        <form method="POST" action="{{route('update.skypeID')}}">
                                            ...
                                            <button type="submit" class="btn btn-success btn btn-info btn-default-color" >Update</button>
                                        </form>
                                        @endif
                                    </div>
                                    <div class="col-md-6 " >
                        ...
                        <div class="col-md-3" style="border: 1px solid #eee; margin-left: 30px;" >
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="card-header m-0 p-0" style="border-bottom-width: inherit;">
                                            <button type="button" class="text-left m-0 p-0 btn btn-link btn-block " id="timeline-1">
                                                <p class=" text-center btn btn-danger btn-default-color">View Status Timeline <i class="fa fa-eye"></i></p>
                                            </button>
                                        </div>
                                        <div class="timeline-1 hide" style="border-top: 1px solid #7862a21c;">
                                            <br>
