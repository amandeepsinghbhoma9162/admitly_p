        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                            <label for="input-id" class="col-sm-2">Upload Student Documents<span class="text-danger">*</span> </label>
                            <div class="col-sm-10"> 
                                <div class="blahSize2">
                            ...
                            @foreach($student->studentDocument as $document)
                            <div class="logoSize wilHide2 float-left">
                                <img class="blah" src="{{asset($document['path']."/".$document['name'])}}" alt="your image" />
                               

                            </div>
                            
                            @endforeach
                            <input type="file" name="document[]" class="mb-2 form-control imgInp2" multiple >
