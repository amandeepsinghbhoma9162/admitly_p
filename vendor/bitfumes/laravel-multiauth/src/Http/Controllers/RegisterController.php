...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function update(Admin $admin, AdminRequest $request)
    {
        ...
        $admin->roles()->sync(request('role_id'));
        $uptd = Admin::where('email',$request->email)->update(['country'=>$request->country]);
    ...
    public function destroy(Admin $admin)
    {
        ...
        public function passwordupdate(Admin $admin, AdminRequest $request)
    {
        dd('aa');
    
        $uptd = Admin::where('password', bcrypt($request->get('password')))->update();
